...
if __name__ == "__main__":
    ...
    #python ./python/image_composition.py --input_dir ./datasets/pinecones_dataset/input --output_dir ./datasets/pinecones_dataset/output --count 11000 --width 512 --height 512
