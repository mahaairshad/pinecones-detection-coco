...
#python ./python/coco_json_utils.py -md ./datasets/pinecones_dataset/train/mask_definitions.json -di ./datasets/pinecones_dataset/train/dataset_info.json
#python ./python/coco_json_utils.py -md ./datasets/pinecones_dataset/test/mask_definitions.json -di ./datasets/pinecones_dataset/test/dataset_info.json
